...
#ressources
background=pygame.image.load("Main/background.jpg").convert()
...
#Polices
try:
    FONT_TITLE=pygame.font.Font("Main/World-of-spell.ttf",72)
    FONT_BUTTON=pygame.font.Font("Main/World-of-spell.ttf;",36)
...
class Button:
    ...
    def draw(self, win, mouse_pos):
        is_hovered = self.react.collidepoint(mouse_pos)
...
while running:
    ...
    title = FONT_TITLE.render("Deep Nature - The Awakening", True, WHITE)
    shadow = FONT_TITLE.render("Deep Nature - The Awakening", True, SHADOW)
